...
_svin_menu_item_type _svin_menu_items[12];
...
_svin_menu_populate(int jump, const char * text)
{
        ...
        if (_svin_menu_items_count >= 12) return;
...
_svin_menu_activate()
{
        ...
        assert(_svin_menu_items_count<13);
        ...
        //menu is 48x20 tiles, to fit into a single plane, and into the same tilespace as dialog 
        int index = 0;
        int iOffset;
