...
#define _SVIN_NBG2_CHPNDR_TEXTBOX_SIZE (640*96)
...
#define _SVIN_VDP1_ORDER_SPRITE_BLOCK_A_INDEX(x)   (4+x)
#define _SVIN_VDP1_ORDER_DRAW_END_A_INDEX          19
#define _SVIN_VDP1_ORDER_LOCAL_COORDS_B_INDEX      20
#define _SVIN_VDP1_ORDER_SPRITE_B0_INDEX           21
#define _SVIN_VDP1_ORDER_SPRITE_B1_INDEX           22
#define _SVIN_VDP1_ORDER_SPRITE_BLOCK_B_INDEX(x)   (23+x)
#define _SVIN_VDP1_ORDER_DRAW_END_B_INDEX          38
#define _SVIN_VDP1_ORDER_COUNT                     39
